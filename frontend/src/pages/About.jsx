        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              et domotique. Depuis 9 ans, nous accompagnons particuliers et professionnels 
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-600">
                <p className="text-lg leading-relaxed">
                  Fondée en 2023 par Yassine Lassoued, inventeur électrique et électricien qualifié talentueux avec plus de 3 ans d'expérience, 
            ...
            <div className="bg-blue-600 rounded-2xl p-8 text-white">
              <div className="space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-lg">Fondée en 2023</span>
                </div>
                <div className="flex items-center space-x-3">
